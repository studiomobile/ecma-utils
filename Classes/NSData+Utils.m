...
int to_base64(const unsigned char *data, size_t dataLen, unsigned char **base64Result, size_t *base64ResultSize) {
	...
	unsigned char *base64Data = (unsigned char*)malloc(sizeof(char)*base64DataLen);
